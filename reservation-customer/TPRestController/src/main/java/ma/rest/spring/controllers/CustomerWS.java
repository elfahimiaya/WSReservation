 ...
 * 2024-12-13T02:35:47.471+01:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/C:/Users/PC/Desktop/emsi/reservation-customer/TPRestController/src/main/resources/CustomerService.wsdl",
                  targetNamespace = "http://controllers.spring.rest.ma/")
public class CustomerWS extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://controllers.spring.rest.ma/", "CustomerWS");
    public final static QName CustomerSoapServicePort = new QName("http://controllers.spring.rest.ma/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/PC/Desktop/emsi/reservation-customer/TPRestController/src/main/resources/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/PC/Desktop/emsi/reservation-customer/TPRestController/src/main/resources/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
