 ...
 * generated in the ma.rest.spring.controllers package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://controllers.spring.rest.ma/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://controllers.spring.rest.ma/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://controllers.spring.rest.ma/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://controllers.spring.rest.ma/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://controllers.spring.rest.ma/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://controllers.spring.rest.ma/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ma.rest.spring.controllers
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://controllers.spring.rest.ma/", name = "saveCustomerResponse")
